...
SQRL Client apps are available and in development for Windows, Mac, Linux, Android, iOS, as well as browser plugins, and server libraries exist for .NET Core, Java, Go and more. There is even a Wordpress plugin.

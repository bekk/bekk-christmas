...
![To enable Dependabot, click on the "Security" button.](https://i.ibb.co/kScW0pN/screenshot-2020-11-21-at-18-06-01-1.png)
...
![Security: Dependabot alerts](https://i.ibb.co/VMrM5Kh/screenshot-2020-11-16-at-19-59-16.png "Unresolved Dependabot alerts are listed in the repository.")
...
![Example pull request generated by Dependabot](https://i.ibb.co/2vr3GBb/dependabot-pull-request.png "A pull request generated by Dependabot")
...
![Error message: Dependabot cannot update to the required version](https://i.ibb.co/xXLhGLr/dependabot-pr-error.png "More often than not, Dependabot is unable to generate a pull request")

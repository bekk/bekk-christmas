...
authors:
  - Linn Harbo Dahle
---
Ambisjoner og måltall - hvordan vi prøvde å jobbe med teamets retning - tittel?



En historie om hvordan produktteamet prøvde seg frem for å finne ut hva vi ville få til. Vi jobbet frem noen ambisjoner og strevde med å finne gode måltall. Litt om hvordan vi måtte tenke noen hakk større enn vi var vant til. Og litt om at det ikke var lett. 
...
Bransjens prater om Lean Canvas, Business Model Canvas, OKRs og presentasjon fra Finn.no om ambisjoner og mål gav stor inspirasjon til hva vi burde vurdere nå. De ulike elementene vi jobbet med ble ambisjon, problem, verdi til bruker, verdi til organisasjon og hvordan måle at vi oppnår denne verdien. Dette ble en tom mal med diskusjonspunkter, og ble etter hvert kalt «ambisjonskanvas». Håpet var at dette kunne skape et grunnlag for arbeidsmøter for å hjelpe oss å komme i gang med de viktige og riktige diskusjonene rundt hvor vi ville, hva vi skulle prioritere og hva vi ville oppnå. 

Hvorfor skulle vi ikke snakke om hva vi skulle lage? 

I vår bransje bør målet aldri være «å lage noe». Å ha laget noe gir ikke verdi i seg selv. Et nytt produkt er ikke automatisk nyttig helt av seg selv. Se for deg den fantastiske tekannen som er bokomslaget på «Design for everyday things» av Don Norman. Her kan en tenke at noen hadde satt seg målet om å lage en tekanne. Og så laget de en tekanne. De oppnådde målet. Det kan ingen si noe på. Men var det nyttig? Vil brukeren av denne tekannen kunne bruke den? Var det riktig å bruke tid på å lage noe som ingen trenger?

https://dribbble.com/shots/5240543-20-100-Coffeepot-for-Masochists 

Bok: The Design of Everyday Things - Don Norman. Illustrasjon av Anca doodles



Prosessen vi hadde (littegrann forenklet…)
...
Ett tips: hver gang noen begynte å snakke om hvordan vi skal løse dette, gjentok jeg følgende spørsmål i ulike varianter: «hva ønsker vi å oppnå?». «Hva ønsker vi EGENTLIG å oppnå?» «Hva vil det gi av verdi til brukeren?”. For å fange essensen av det vi snakket om. Og samtidig, parkerte vi tanken om løsning på en lapp. Det var jo ikke det at det var uinteressant. Det var bare ikke nå vi skulle diskutere hvordan. Vi skulle ha fokus på hva vi ønsket å oppnå i lengden. 

Et stort nok problem

Vi trengte å tydeliggjøre hvilken situasjon vi ønsket å gjøre bedre, og for hvem. Problemet som skulle heves frem var ikke på et detaljert, brukergrensesnitt-nivå, men på et “høyere” overordnet nivå. Et problem som var stort og viktig nok. 
...
Etter arbeidsmøtene der vi gikk bredt ut og jobbet med flere ambisjoner og fokus på en gang, så var det på tide å samle oss. Alt var jo så viktig! Hvilken ambisjon skulle vi jobbe med først? Vi måtte prioritere ambisjonene. Gjennom litt dot-voting, diskusjon og tenking så gikk vi for ett fokus. En ambisjon. 

Hvordan kunne vi vite at vi gikk i riktig av ambisjonen?

I teamet har vi jobbet hypotesedrevet i cirka ett år, altså at de løsningene vi har gått for har vi formulert som hypoteser, som har blitt testet og vi har lært om antagelsen om løsning faktisk løste problemet. Mer om prosessen vår rundt hypoteser.
...
Da måtte vi stoppe opp! Tenke på hvorfor vi jobber med disse målingene. Det er jo bare et hjelpemiddel. Selvfølgelig skulle vi fortsatt gjøre det vi trodde var det lureste å jobbe med. Og om vi ikke kom på noen geniale måltall før vi lanserte, så kanskje vi kom på noe senere, når vi fikk øvd oss mer på dette. 



For uansett: måltallet måtte aldri bli målet i seg selv! For det kunne virkelig gått utover brukeropplevelsen hvis vi skulle optimalisert tjenesten for å få til et godt måltall...

https://twitter.com/necolas/status/1096221537537933312 
...
Det gjør litt vondt å dele malen til ambisjonskanvaset i dette blogginnlegget. Rett og slett fordi den ikke er viktig! Det er ikke viktig å fylle ut noen mal, for det har ikke noen verdi i seg selv. Det som har vært viktig er at teamet har fått diskutert hva vi ønsker å oppnå. Det er ikke lett, og for oss hjalp ambisjonskanvaset oss til å styre diskusjonen bort fra løsning og inn på hva som er riktig og viktig både for brukeren og organisasjonen.
...
Bare prøv. Og del gjerne hvordan du og ditt team jobber med ambisjon og retning! 



Mer om OKRs https://blogg.bekk.no/okr-rammeverket-som-skaper-verdens-beste-bedrifter-2de7a2266c5a 

Og podkasten om OKR 

https://product.christmas/2019/11

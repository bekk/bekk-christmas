...
Well, facing this problem at out current client, we have a design that is really tied up to the a custom font that the client is using. Nailing the typography implementation would greatly improve the design, and improve the readability. 

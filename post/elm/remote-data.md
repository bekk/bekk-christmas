...
The Elm package directory has [a package for `RemoteData`](https://package.elm-lang.org/packages/krisajenkins/remotedata/6.0.1), which contains a custom type and some helper functions, but I usually prefer to make my own when using this pattern in Elm. However you decide to do it, I hope you try out this technique for modelling remote data in Elm.
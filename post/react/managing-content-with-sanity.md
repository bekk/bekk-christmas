...
Sanity is configured in a matter of minutes. First register your account [here](https://sanity.io/create)(or with the CLI) and proceed with the following command:

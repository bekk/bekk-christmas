...
As a thought experiment, let’s say we are single threaded as well. Therefore, when we read the recipe for the ``ChristmasDinner``, we read the recipe from top to bottom, executing tasks as we go. 
...
<td style="border: inherit">
<img src="https://i.ibb.co/3R8yD1Y/The-recipe-part-2.png" alt="Shows how JS execute the first function called" style="width:420px;"/>
</td>
...
<img src="https://i.ibb.co/5MVjR3M/Screenshot-2020-12-12-at-23-58-50.png" alt="Showing how the call stack pushes the setTimeout function onto the Web API" style="width:500px;"/>
...
<td style="border: inherit">
<img src="https://i.ibb.co/Jn0Ysn0/Screenshot-2020-12-12-at-23-58-57.png" alt="Showing how the Web API pushes the function onto the queue" style="width:410px;"/>
</td>

<td style="border: inherit">
<img src="https://i.ibb.co/ssXw2nJ/Screenshot-2020-12-12-at-23-59-04.png" alt="Shows how the Event loop pushes the function back onto the stack" style="width:400px;"/>
</td>
...
<img src="https://i.ibb.co/GPhw6mk/Screenshot-2020-12-12-at-23-59-15.png" alt="Shows how function is pushed on to the last place in the queue" style="width:500px;"/>
